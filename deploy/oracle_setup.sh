...
[[ -f "$SCRIPT_DIR/systemd/bitcoin-bot-resource-guard.service" \
  ...
  fail 'resource guard or state-backup systemd units are missing'
...
as_root touch "$BACKUP_LOCK"
as_root chown root:root "$BACKUP_LOCK"
as_root chmod 0600 "$BACKUP_LOCK"
