...
at `/etc/bitcoin-live/.env`, outside the immutable release tree. Leave
...
The supplied AWS TestNet incident evidence, non-core parity corrections and
protected-core boundary are recorded in
