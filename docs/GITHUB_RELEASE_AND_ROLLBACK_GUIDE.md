...
release identity and image tag. Oracle snapshots `/etc/bitcoin-live/.env` to a
...
`/opt/bitcoin-live/current` is switched atomically. Do not edit this link, a config
